...
(function(){dust.register("app/templates/dataView",body_0);function body_0(chk,ctx){return chk.w("<table><tr><th>ID</th><th>Alt</th><th>URL</th><th>Name</th><th>Phone</th><th>Hours</th><th>Type</th><th>Address</th><th>City</th><th>State</th><th>ZIP</th></tr>").s(ctx.get(["stores"], false),ctx,{"block":body_1},{}).w("</table>");}body_0.__dustBody=!0;function body_1(chk,ctx){return chk.w("<tr><td>").f(ctx.get(["id"], false),ctx,"h").w("</td><td>").f(ctx.get(["alt"], false),ctx,"h").w("</td><td>").f(ctx.get(["url"], false),ctx,"h").w("</td><td>").f(ctx.get(["name"], false),ctx,"h").w("</td><td>").f(ctx.get(["phone"], false),ctx,"h").w("</td><td>Monday: ").f(ctx.get(["monday"], false),ctx,"h").w("<br>Tuesday: ").f(ctx.get(["tuesday"], false),ctx,"h").w(" <br>Wednseday: ").f(ctx.get(["wednesday"], false),ctx,"h").w("<br> Thursday: ").f(ctx.get(["thursday"], false),ctx,"h").w("<br> Friday: ").f(ctx.get(["friday"], false),ctx,"h").w("<br>Saturday: ").f(ctx.get(["saturday"], false),ctx,"h").w("<br>Sunday: ").f(ctx.get(["sunday"], false),ctx,"h").w("</td><td>").f(ctx.get(["type"], false),ctx,"h").w("</td><td>").f(ctx.get(["address"], false),ctx,"h").w("</td><td>").f(ctx.get(["city"], false),ctx,"h").w("</td><td>").f(ctx.get(["state"], false),ctx,"h").w("</td><td>").f(ctx.get(["zip"], false),ctx,"h").w("</td></tr>");}body_1.__dustBody=!0;return body_0;})();module.exports = function (context, callback) { dust.render("app/templates/dataView", context, callback); };
}).call(this);
